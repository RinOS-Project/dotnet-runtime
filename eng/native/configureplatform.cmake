...
if(CLR_CMAKE_HOST_OS STREQUAL rinos)
    set(CLR_CMAKE_HOST_UNIX 1)
    set(CLR_CMAKE_HOST_RINOS 1)
    if(CMAKE_SYSTEM_PROCESSOR STREQUAL x86_64 OR CMAKE_SYSTEM_PROCESSOR STREQUAL amd64)
        set(CLR_CMAKE_HOST_UNIX_AMD64 1)
    else()
        clr_unknown_arch()
    endif()
endif(CLR_CMAKE_HOST_OS STREQUAL rinos)
...
if(CLR_CMAKE_TARGET_OS STREQUAL rinos)
    set(CLR_CMAKE_TARGET_UNIX 1)
    set(CLR_CMAKE_TARGET_RINOS 1)
endif(CLR_CMAKE_TARGET_OS STREQUAL rinos)
...
if (NOT (CLR_CMAKE_TARGET_OS STREQUAL CLR_CMAKE_HOST_OS) AND NOT CLR_CMAKE_TARGET_WASI AND NOT CLR_CMAKE_TARGET_ANDROID AND NOT CLR_CMAKE_TARGET_BROWSER)
    if(NOT (CLR_CMAKE_HOST_OS STREQUAL windows OR CLR_CMAKE_HOST_OS STREQUAL linux))
        message(FATAL_ERROR "Invalid host and target os/arch combination. Host OS: ${CLR_CMAKE_HOST_OS}")
    endif()
    if(NOT (CLR_CMAKE_TARGET_LINUX OR CLR_CMAKE_TARGET_LINUX_MUSL OR CLR_CMAKE_TARGET_RINOS))
...
if (NOT CLR_CMAKE_TARGET_ANDROID AND NOT CLR_CMAKE_TARGET_APPLE_MOBILE AND NOT CLR_CMAKE_TARGET_BROWSER AND NOT CLR_CMAKE_TARGET_WASI AND NOT CLR_CMAKE_TARGET_RINOS)
